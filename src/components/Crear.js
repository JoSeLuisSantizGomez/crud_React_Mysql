                ...
                <div className="card-body">
                    <form onSubmit={this.enviarDatos}>
                        <div className="form-group">
                            ...
                            <input type="text" name="nombre" id="nombre" onChange={this.cambioValor} value={nombre} 
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" name="correo" id="correo" onChange={this.cambioValor} value={correo} 
                                className={( (this.verificarError("error_correo"))?"is-invalid":"")+" form-control"} placeholder="" aria-describedby="helpId"
                            />
                            <small id="helpId" className="invalid-feedback">Escribe el correo</small>
                        </div>
